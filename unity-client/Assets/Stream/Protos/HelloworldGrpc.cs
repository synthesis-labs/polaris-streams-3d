...
namespace Helloworld {
  ...
  {
    static readonly string __ServiceName = "helloworld.MultiGreeter";
    ...
    {
      public virtual global::System.Threading.Tasks.Task SayHello(global::Helloworld.HelloRequest request, grpc::IServerStreamWriter<global::Helloworld.HelloReply> responseStream, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public partial class MultiGreeterClient : grpc::ClientBase<MultiGreeterClient>
    {
      ...
      /// <param name="channel">The channel to use to make remote calls.</param>
      public MultiGreeterClient(grpc::Channel channel) : base(channel)
      {
      }
      ...
      public virtual grpc::AsyncServerStreamingCall<global::Helloworld.HelloReply> SayHello(global::Helloworld.HelloRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return SayHello(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncServerStreamingCall<global::Helloworld.HelloReply> SayHello(global::Helloworld.HelloRequest request, grpc::CallOptions options)
      {
    ...
    {
      serviceBinder.AddMethod(__Method_SayHello, serviceImpl == null ? null : new grpc::ServerStreamingServerMethod<global::Helloworld.HelloRequest, global::Helloworld.HelloReply>(serviceImpl.SayHello));
    }
